 ...
 */
package br.com.thiagomoreira.foursquare.security;
...
public class FoursquareAuthorizationInterceptor implements Interceptor {

	protected String clientId;
	protected String clientSecret;
	protected String accessToken;

	public FoursquareAuthorizationInterceptor(String clientId,
	...
	public Response intercept(Chain chain) throws IOException {
		...
		builder = builder.addQueryParameter("v", "20170801");
